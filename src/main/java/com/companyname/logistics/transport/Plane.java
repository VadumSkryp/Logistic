...
import com.companyname.logistics.resource.Medications;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

public class Plane extends Transport<Medications> {
    ...
    public Plane(String name, double capacity, double speed) {
        super(name, capacity, speed);
    }


    @Override
    public void deliver(Medications resource, Location from, Location to) {
